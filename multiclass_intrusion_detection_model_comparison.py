...
# === 3. Transforming the target into binary (Benign=0, Attack=1) ===
...
# === 5. Balancing classes using undersampling ===
benign = df_cleaned[df_cleaned['attack'] == 0]
attack = df_cleaned[df_cleaned['attack'] == 1]

min_class_size = min(len(benign), len(attack))
if min_class_size == 0:
    raise ValueError("One of the classes is empty after labeling. Check the values in the 'class' column.")
...
# === 9. Defining the ML models to evaluate ===
models = {
